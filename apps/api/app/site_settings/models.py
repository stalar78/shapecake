...
class SiteSettings(TimestampMixin, Base):
    ...
    about_master_image_storage_key: Mapped[str | None] = mapped_column(String(500), nullable=True)
    about_master_image_original_filename: Mapped[str | None] = mapped_column(String(255), nullable=True)
    about_master_image_mime_type: Mapped[str | None] = mapped_column(String(80), nullable=True)
    about_master_image_file_size: Mapped[int | None] = mapped_column(nullable=True)
    craft_image_storage_key: Mapped[str | None] = mapped_column(String(500), nullable=True)
    craft_image_original_filename: Mapped[str | None] = mapped_column(String(255), nullable=True)
    craft_image_mime_type: Mapped[str | None] = mapped_column(String(80), nullable=True)
    craft_image_file_size: Mapped[int | None] = mapped_column(nullable=True)
